...
class FlutterRemoteWebViewClient {
    ...
    private void notifyOnNavigationRequest(
        ...
        if (isMainFrame) {
            //todo methodChannel.invokeMethod("navigationRequest", args, new OnNavigationRequestResult(url, headers, webview));
        } else {
            //todo methodChannel.invokeMethod("navigationRequest", args);
        }
    }
    ...
    private WebViewClient internalCreateWebViewClient() {
        return new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                return FlutterRemoteWebViewClient.this.shouldOverrideUrlLoading(view, request);
            }

            @Override
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                FlutterRemoteWebViewClient.this.onPageStarted(view, url);
            }

            @Override
            public void onPageFinished(WebView view, String url) {
                FlutterRemoteWebViewClient.this.onPageFinished(view, url);
            }
            ...
            public void onReceivedError(
                ...
                if (request.isForMainFrame()) {
                    FlutterRemoteWebViewClient.this.onWebResourceError(
            ...
            public void onReceivedError(
                ...
                FlutterRemoteWebViewClient.this.onWebResourceError(errorCode, description, failingUrl);
            }
    ...
    private WebViewClientCompat internalCreateWebViewClientCompat() {
        return new WebViewClientCompat() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                return FlutterRemoteWebViewClient.this.shouldOverrideUrlLoading(view, url);
            }
